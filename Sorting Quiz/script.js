let currentQuestion = 0;
    ...
    const houseColors = {
        Gryffindor: { background: "#68251f", text: "#ffd700", buttonBackground: "#ffd700", buttonText: "#68251f" }, // Red background, golden text, dark red button
        Slytherin: { background: "#4b8646", text: "#ffffff", buttonBackground: "#ffffff", buttonText: "#4b8646" }, // Green background, white text, dark green button
        Hufflepuff: { background: "#edd364", text: "#000000", buttonBackground: "#000000", buttonText: "#edd364" }, // Yellow background, black text, dark yellow button
        Ravenclaw: { background: "#2864ca", text: "#ffffff", buttonBackground: "#ffffff", buttonText: "#2864ca" } // Blue background, white text, dark blue button
    };
    ...
    winDialogContent.innerHTML = `
        ...
        <h2>Your are sorted in: ${house}</h2>
